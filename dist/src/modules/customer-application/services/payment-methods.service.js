...
let PaymentMethodsService = class PaymentMethodsService {
    ...
    getPaymentMethods(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.paymentMethodModel.find({ user: req.user._id });
        });
    }
    removePaymentMethod(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.paymentMethodModel.findByIdAndDelete(id);
        });
    }
};
...
exports.PaymentMethodsService = PaymentMethodsService = __decorate([
    ...
    __param(0, (0, common_1.Inject)(model_metadata_1.ModelMetadata.PaymentMethod.token)),
